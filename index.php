...
<html lang="en">
<head>
  <title>WELCOME - HOTEL ALILA PURNAMA</title>
  <meta charset="utf-8">
...
<div class="p-2 bg-secondary text-white text-center">
  <h1>HOTEL ALILA PURNAMA</h1>
  <p>Selamat datang di Hotel Alila Purnama</p> 
</div>
<!------------------AKHIR BAGIAN HEADER----------------- -->
...
<nav class="navbar navbar-expand-sm navbar-dark bg-success">
      ...
      <a class="navbar-brand" href="#">HOTEL ALILA PURNAMA</a>
...
<div class="container mt-2" id="panel_fasilitas_kami">
    <h2 class="text-center" >FASILITAS KAMI</h2>
      <h5 class="text-center">Hotel Alila Purnama</h5>
      ...
      <div class="card mt-2">
      <div class="card-colum bg-success">
        <h5><?php echo $nf ; ?></h5>
        <p><?php echo $ket ; ?></p>
  ...
  <div class="d-flex justify-content-center">
    <div class="row">
     <div class="col-sm-12 p-5">
      ...
      <p> <b>Hotel Alila Purnama</b>Hotel Alila Purnama terkenal dengan keramahan kelas dunia. desain hotel yang mengagumkan dan standart layanan yang tak tertandingi didaerah yogyakarta. hotel alila purnama adalah resort bintang lima yang pertama dikota yogyakarta . hotel alila purnama tergolong masih baru dengan fasilitas yang tentunya akan membuat anda nyaman selama menginap. setiap kamar menawarkan pemandangan indah nan asri dengan jendela besar untuk menikmati cahaya keemasan dari matahari.    
    </p>
   </div>
  </div>
